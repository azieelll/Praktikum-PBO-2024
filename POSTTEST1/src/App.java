...
public class App {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            System.out.println("");
            System.out.println("======================");
            System.out.println("|  SISTEM PENDATAAN  |");
            System.out.println("|   ROKOK  DI INDO   |");
            System.out.println("======================");
            System.out.println("");
            System.out.println("~~~~~~~~~~~~~~~~~~~~~~");
            System.out.println("|   1. Lihat Rokok   |");
            System.out.println("|   2. Tambah Rokok  |");
            System.out.println("|   3. Ubah Rokok    |");
            System.out.println("|   4. Hapus Rokok   |");
    ...
    public static void tampilkanRokok(ArrayList<Rokok> Rokok) {
        if (Rokok.isEmpty()) {
            System.out.println("Belum Ada Data Rokok");
        } else {
            System.out.println("====================================================================================");
